...
import {
  ...
  ChevronDown, ChevronUp, Menu, X, Phone, Mail, MapPin, Check,
  Star, Building2, DollarSign, Megaphone, LineChart, Layers,
  ...
  XCircle, CheckCircle2, Crosshair, Timer, BookOpen, Cpu,
  SlidersHorizontal, Sparkles, MousePointerClick, PhoneCall,
  MessageSquare, UserCheck, Linkedin, Globe, FileText
} from 'lucide-react'
