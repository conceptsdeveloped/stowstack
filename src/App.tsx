...
function ScheduleCallSection() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      Cal("init", "stowstack", {origin:"https://cal.com"});
      Cal.ns.stowstack("inline", {
        elementOrSelector:"#cal-embed",
        calLink: "stowstack",
        layout: "month_view",
        config: { theme: "light" }
      });
      Cal.ns.stowstack("ui", {"hideEventTypeDetails":false,"layout":"month_view","cssVarsPerTheme":{"light":{"cal-brand":"#16a34a","cal-brand-emphasis":"#15803d"}}});
    `
      ...
      <div className="max-w-5xl mx-auto px-5">
        ...
        <Reveal delay={200}>
          <div className="bg-white rounded-2xl border border-border/60 shadow-lg overflow-hidden">
            ...
            <div ref={calRef} id="cal-embed" style={{ width: '100%', minHeight: '650px', overflow: 'auto' }} />
          </div>
        </Reveal>
