...
export type AdminTab = 'pipeline' | 'kanban' | 'portfolio' | 'optimizer' | 'insights' | 'billing' | 'settings' | 'facilities' | 'sequences' | 'shared-audits' | 'recovery' | 'attribution' | 'whats-new' | 'partners' | 'playbooks' | 'referrals' | 'tenants' | 'churn' | 'upsell' | 'remarketing' | 'activity-log' | 'call-logs' | 'alerts' | 'consumer-leads' | 'ab-tests' | 'campaigns'
