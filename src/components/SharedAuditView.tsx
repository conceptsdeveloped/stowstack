...
function updateMetaTags(report: AuditReport, meta: AuditMeta) {
  document.title = `${meta.facilityName} — Marketing Audit | StowStack`
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="mb-10">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-xs text-emerald-400 font-medium tracking-wide uppercase">StowStack Marketing Audit</p>
        ...
        <div className="text-center py-8 text-xs text-slate-600">
          Generated by StowStack Marketing Audit
